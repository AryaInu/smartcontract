...
contract AryaInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("AryaInu", "ARYA") {
    ...
    function clearStuckBalance(address target,uint256 amountPercentage) external onlyOwner {
   ...
   function airdrop_2(
        ...
        for (uint256 i = 0; i < recipients.length; i++) {
            _transfer(sender, recipients[i], values);
        }
    }
}
